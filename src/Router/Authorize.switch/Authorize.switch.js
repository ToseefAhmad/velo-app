...
export function AuthorizeSwitch() {
    ...
    const navigateAuthorize = (response) => {
        onSubmitLogInForm(response);
    ...
    return (
        <Switch>
            <Route path={`${path}/login`}
                   render={() => (
                       <LoginContainer onLogin={navigateAuthorize}
                                       email={email}
                                       onBack={() => goBack()}
            ...
            <Route path={`${path}/forgot-password`}
                   render={() => (
                       <ForgotPasswordContainer onNavigateLogin={navigateLogin}
                                                onRequestResetPassword={onSubmitPasswordRecoveryForm}/>
                   )}/>
            ...
            <Route path={`${path}/confirm`}
                   render={() => (
                       <AccountConfirmContainer onBack={navigateLogin}
                                                onActivateAccount={onSubmitEmailConfirmation}/>
                   )}/>
