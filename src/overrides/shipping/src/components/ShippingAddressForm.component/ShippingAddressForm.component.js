...
import type {ShippingCartAddress, User} from '@luft/types';
...
import custom_messages from '../../../../../shipping/components/ShippingAddressBook.component/resources/messages';
...
export function ShippingAddressFormComponent(props: Props) {
    ...
    const handleOnSaveAddress = async (data) => {
        const {city, other_city, ...address} = data;

        return onSaveAddress && await onSaveAddress({
            ...address,
