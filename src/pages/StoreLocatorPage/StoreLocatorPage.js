...
import defaultIcon from '../../common/resources/images/velo-marker.png';
import selectedIcon from '../../common/resources/images/velo-marker-selected.png';
import clusterIcon1 from '../../common/resources/svg/velo-map-cluster-1.svg';
import clusterIcon2 from '../../common/resources/svg/velo-map-cluster-2.svg';
import clusterIcon3 from '../../common/resources/svg/velo-map-cluster-3.svg';
        ...
        <GoogleMapProviderContainer locationMapRef={locationMapRef}
            ...
            <div className="store-locator-page">
                <div className="store-locator-page-body">
                    <SearchLocationComponent brandName="VELO"/>
